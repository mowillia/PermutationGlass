...
- [`temp_vs_signorm.ipynb`](https://github.com/mowillia/PermutationGlass/blob/master/temp_vs_sigmanorm.ipynb): Reproduces Figure 3; Runs in < 1 sec
- [`perm_glass_simulation.ipynb`](https://github.com/mowillia/PermutationGlass/blob/master/perm_glass_simulation.ipynb): Reproduces Figure 4; Runs in < 5 minutes
- [`prob_neglambda_vs_N.ipynb`](https://github.com/mowillia/PermutationGlass/blob/master/prob_neglambda_vs_N.ipynb): Reproduces Figure 5; Runs in < 1 sec
