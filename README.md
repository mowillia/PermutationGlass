...
- [`temp_vs_signorm.ipynb`](https://github.com/mowillia/PermutationGlass/blob/main/temp_vs_signorm.ipynb): Reproduces Figure 3; Runs in < 1 sec
- [`perm_glass_simulation.ipynb`](https://github.com/mowillia/PermutationGlass/blob/main/perm_glass_simulation.ipynb): Reproduces Figure 4; Runs in < 5 minutes
- [`prob_neglambda_vs_N.ipynb`](https://github.com/mowillia/PermutationGlass/blob/main/prob_neglambda_vs_N.ipynb): Reproduces Figure 5; Runs in < 1 sec
